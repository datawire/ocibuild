...
func testDownloadedWheels(t *testing.T, fn func(t *testing.T, filename string, content []byte)) {
	...
	downloads := []Download{
		...
		//{"MarkupSafe", "1.1.1", "MarkupSafe-1.1.1-cp39-cp39-manylinux2010_x86_64.whl", "e7ac35d3dc0f243fcff0cb30b2f9a2bf2558d2d3"},
		//{"PyYAML", "5.4.1", "PyYAML-5.4.1-cp39-cp39-manylinux1_x86_64.whl", "345cdbb6c61904da097ad4b586d9632fac4676c8"},
		...
		//{"coverage", "5.3", "coverage-5.3-cp39-cp39-manylinux1_x86_64.whl", "a8c7cc5f30dbcd48a07a62900d80f0da1e481b94"},
		...
		//{"typed_ast", "1.4.1", "typed_ast-1.4.1-cp39-cp39-manylinux1_x86_64.whl", "236c40b429b777dcfe597a76c2be95d6081d85f2"},
